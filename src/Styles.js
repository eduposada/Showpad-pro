export const styles = {
    // ... (mantenha o início igual ao anterior)
    ...
    mainEditor: { flex: 1, display: 'flex', flexDirection: 'column', backgroundColor:'#000', overflow: 'hidden' },
    ...
    // --- ESTILO DA ABA BANDA (REQUISITO 1 E 2) ---
    ...
    primaryButton: { width: '100%', padding: '12px', backgroundColor: '#007aff', border: 'none', borderRadius: '8px', color: '#fff', fontWeight: 'bold', cursor:'pointer' },
