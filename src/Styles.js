export const styles = {
    ...
    // BARRA LATERAL (320px para não quebrar nomes)
    ...
    importBtnLabel: { width: '100%', padding: '12px', backgroundColor: '#34c759', border: 'none', borderRadius: '8px', color: '#fff', fontWeight:'bold', cursor:'pointer', textAlign:'center', fontSize:'11px', display:'flex', alignItems:'center', justifyContent:'center' },
    
    // EDITOR PRINCIPAL (LETRA BRANCA GARANTIDA)
    ...
    // GARIMPO (VISUAL APROVADO: PRETO E BRANCO)
    ...
    // SETLIST EM DOIS PAINÉIS (RESTAURADO)
