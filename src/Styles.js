export const styles = {
    ...
    // BOTÕES DE ORDENAÇÃO (CORRIGIDOS: ESCUROS E ELEGANTES)
    ...
    sortBtn: { flex: 1, padding:'6px', background:'#2c2c2e', border:'1px solid #444', color:'#aaa', borderRadius:'6px', display:'flex', alignItems:'center', justifyContent:'center', gap:'6px', cursor:'pointer', fontSize:'10px' },
    ...
    // RODAPÉ COM BOTÕES DE TAMANHOS IDÊNTICOS (SIMETRIA)
    ...
    importBtnLabel: { width: '100%', height: '45px', backgroundColor: '#34c759', border: 'none', borderRadius: '8px', color: '#FFF', fontWeight:'bold', cursor:'pointer', textAlign:'center', fontSize:'11px', display:'flex', alignItems:'center', justifyContent:'center' },
    
    // EDITOR PRINCIPAL (TRAVADO NO BRANCO/PRETO)
    ...
    // GARIMPO PANEL (RESTAURADO E BLINDADO)
