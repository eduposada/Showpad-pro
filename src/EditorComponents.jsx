...
export const MainEditor = ({ item, songs, triggerDL, onClose, onShow, refresh, styles }) => {
    ...
    const [lLoc, setLLoc] = useState(item.data.location || ""), [lTim, setLTim] = useState(item.data.time || ""), [lMem, setLMem] = useState(item.data.members || ""), [lNot, setLNot] = useState(item.data.notes || "");
