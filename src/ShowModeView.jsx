    ...
    return (
        <div style={styles.showOverlay}>
            ...
            <div style={styles.showToolbar}>
                ...
                <div style={{ flex: 1, textAlign: 'center' }}><strong style={{ color: '#fff' }}>{song ? song.title : "Fim"}</strong>{lastSignal && <div style={styles.midiProbeFloating}>MIDI: {lastSignal}</div>}</div>
