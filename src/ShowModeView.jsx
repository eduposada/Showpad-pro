        ...
        return (
            <div style={styles.editorContent}>
                ...
                <div style={styles.showMetaData}>
                    ...
                    <input placeholder="Integrantes" value={lMem} onChange={e=>setLMem(e.target.value)} onBlur={save} style={styles.metaInputWide}/><textarea placeholder="Notas do Show..." value={lNot} onChange={e=>setLNot(e.target.value)} onBlur={save} style={styles.metaTextArea}></textarea>
                </div>
